...
# Concurrent Load Generator for P/D Disaggregation Tracing
#
# This script generates high-concurrency load optimized to showcase P/D disaggregation
# benefits and highlight True TTFT vs vLLM TTFT metrics in distributed traces.
#
# Usage: ./generate-load-pd-concurrent.sh [concurrent_workers] [duration_minutes] [endpoint]
#
...
echo "============================================================"
echo "   P/D Disaggregation Concurrent Load Generator"
echo "============================================================"
